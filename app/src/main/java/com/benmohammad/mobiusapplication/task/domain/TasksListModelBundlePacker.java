...
import static com.benmohammad.mobiusapplication.data.TaskBundlePacker.taskFromBundle;
import static com.benmohammad.mobiusapplication.data.TaskBundlePacker.taskToBundle;
...
public class TasksListModelBundlePacker {
    ...
    public static Bundle taskListModelToBundle(TasksListModel tasksListModel) {
        Bundle b = new Bundle();
